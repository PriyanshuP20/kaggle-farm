...
PLOTS_PER_UNIT = float(_p("ppu", 4))
CREW_MIN = int(_p("crew_min", 5))
MELON_GATE = _p("melon_gate", 802)
PREMIUM_GATE = _p("premium_gate", 2229)
...
BUY_GATE_MONEY = _p("buy_gate", 700)   # cash needed before animal buys
...
SB_CAP = int(_p("sb_cap", 14)); SB_DIV = _p("sb_div", 3)
TOM_CAP = int(_p("tom_cap", 12)); TOM_DIV = _p("tom_div", 3)
CAR_CAP = int(_p("car_cap", 6)); CAR_DIV = _p("car_div", 8)
MELON_CAP = int(_p("melon_cap", 14)); MELON_DIV = _p("melon_div", 3)
...
HERD_TARGET = int(_p("herd_target", 19))
