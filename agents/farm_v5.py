...
# Herd plan — the ranch is the main revenue engine. Eggs are log-glut (price
# barely falls at volume), so geese dominate; a few sheep/cows diversify into
# separate price curves while they're still cheap.
