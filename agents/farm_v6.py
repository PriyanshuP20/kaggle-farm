...
HERD_TARGET = int(os.environ.get("KAG_HERD", 14))
...
def _herd_plan(drain):
    """Fixed base plan (proven) — market-driven variant tested worse."""
    return ["GOOSE", "GOOSE", "GOOSE", "SHEEP", "COW", "GOOSE",
...
def _agent_impl(obs, config):
    ...
    if (money - spend > 1200 and day < last_day + HERD_BUY_LAST_DAY
        ...
        for a in remaining:
            ...
            if have_home and money - spend > ANIMALS[a]["cost"] + 900:
    ...
    if money > 900 and n_units >= 7 and day < last_day - 6:
        have_struct = {}
